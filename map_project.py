...
# 4. RSO ENGINE (Official Sabah/Sarawak Projection)
def latlon_to_borneo_rso(phi, lam):
    # Official JUPEM Constants for Borneo RSO
    a = 6378137.0                   # GRS80 Ellipsoid
    f = 1/298.257222101
    k0 = 0.99984                    
    phi0 = np.radians(4.0)          
    lam0 = np.radians(115.0)        
    gamma0 = np.radians(18.745783)  
    E0 = 590476.66                  # Standard False Easting
    N0 = 442857.65                  # Standard False Northing
    ...
    # Rectification Rotation (Aligning to North-South Grid)
...
def full_transformation(lat_in, lon_in, h_in, dx, dy, dz, rx_s, ry_s, rz_s, s_ppm):
    ...
    # 3. Cartesian to GDM2000 Geodetic
...
# Standard GDM2000 shift often uses 0.0 unless specific local datum ties are needed
...
with col1:
    ...
    # Coordinates for testing to reach target East/North
...
with st.expander("View Logic"):
    ...
    st.write("**Hotine Oblique Mercator (RSO)**")
