...
# 1. PAGE SETUP
st.set_page_config(page_title="Timbalai 1948 Innovation Module", page_icon="📍", layout="wide")

# 2. FUNCTION: LOAD BACKGROUND & CUSTOM STYLES
...
st.markdown(
    ...
    .footer-box {
        ...
        padding: 12px; background-color: rgba(255, 255, 255, 0.4); 
        backdrop-filter: blur(10px); border-right: 5px solid #800000;
