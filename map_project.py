...
# These are the 7 Helmert Parameters
...
# 7. DEVELOPER CREDITS (Bottom Right Footer)
st.markdown(
    """
    <style>
    .footer-box {
    ...
    .footer-text { font-size: 13px; color: #333333; margin: 0; line-height: 1.4; }
    ...
    <div class="footer-box">
        ...
        <p class="footer-text" style="margin-top:5px;"><b>3 SGHU - UTM FABU</b></p>
    </div>
    """,
    unsafe_allow_html=True
)