...
# Defaulting to 0.0 for GDM2000 compatibility as discussed
...
with col1:
    ...
    if st.button("🚀 Transform & Project"):
        ...
        st.session_state.results = {"dms_lat": decimal_to_dms(lat_g), "dms_lon": decimal_to_dms(lon_g, False),
                                   "east": east, "north": north, "cart": cart, "orig_lat": lat_in, "orig_orig": lon_in}
